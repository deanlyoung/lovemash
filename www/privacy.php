	...
	<body>
		...
		<div class="container">
			<div class="top" >
				<div class="main">
					<div class="logo">
						<a href="http://lovemash.us"><img src="http://lovemash.us/images/lovemash-300.png" /></a>
					</div> <!-- .logo -->
					<div class="loginout">
						<?php
			...
			<div class="wrapper">
				<div id="container-area" class="container-area">
					<div class="container-area_p">
						<?PHP include "http://lovemash.us/privacy-info.php" ?>
					</div> <!-- .container-area_p -->
					<div class="clr"></div>
					<div class="footer">
						<?PHP include "http://lovemash.us/footer.php"; ?>
					</div>
				</div> <!-- #container-area -->
			</div> <!-- .wrapper -->
		</div> <!-- .container -->
